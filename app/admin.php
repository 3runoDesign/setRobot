...
if (defined('WP_ENV')) {
    ...
    $adminbarCustomStylFn = function () {
        echo '<style>#wpadminbar .admin-bar__current-env .ab-item{color:#f4f3f4!important;background-color: #fe3055!important}#wpadminbar .admin-bar__current-env[class*="is-staging"] .ab-item{background-color: #ffd84d!important}#wpadminbar .admin-bar__current-env[class*="is-dev"] .ab-item{background-color: #20be51!important}</style>';
    };
