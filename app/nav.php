...
class WalkerTexasRanger extends \Walker_Nav_Menu
{
    ...
    // Check for children
    public function displayElement($element, &$children_elements, $max_depth, $args, &$output, $depth = 0)
    {
        ...
        return parent::displayElement($element, $children_elements, $max_depth, $args, $output, $depth);
    }

    public function startLvl(&$output, $depth = 1, $args = array())
    {
